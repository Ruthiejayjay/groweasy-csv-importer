  ...
  return (
    <div>
      <div className="flex gap-4 mb-5 flex-wrap">
        <div className="flex-1 min-w-[140px] bg-white border border-gray-200 rounded-lg p-4">
          <div className="text-2xl font-bold text-emerald-600">
            {result.totalImported}
          </div>
          <div className="text-sm text-gray-500 mt-0.5">Imported</div>
        </div>
        <div className="flex-1 min-w-[140px] bg-white border border-gray-200 rounded-lg p-4">
          <div className="text-2xl font-bold text-red-600">
            {result.totalSkipped}
          </div>
          <div className="text-sm text-gray-500 mt-0.5">Skipped</div>
        </div>
      </div>
